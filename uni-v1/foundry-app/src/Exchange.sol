...
contract Exchange is ERC20 {
    ...
    // returns the balance of tokens held by this contract
    ...
    function addLiquidity(
        ...
        // If there's no tokens in this contract
        // then transfer token from the caller to this contract
        if (tokenReserveBalance == 0) {
            token.transferFrom(msg.sender, address(this), amountOfToken);
            // mint lpTokens by the amount of eth in this exchange
    ...
    function ethToTokenSwap(uint256 minTokensToReceive) public payable {
        ...
        require(
            ...
            "Tokens received are less than min tokens expected"
        );
